    ...
    setActiveChat(contact){
        ...
        Message.getRef(this._contactActive.chatId).orderBy('timeStamp').onSnapshot(docs => {
            ...
            if (autoScroll) {
                ...
                this.el.panelMessagesContainer.scrollTop = (this.el.panelMessagesContainer.scrollHeight - this.el.
                panelMessagesContainer.offsetHeight);
        ...
        this.el.btnSendPicture.on('click', e => {
            ...
            picture.onload = e => {
                ...
                .then(file => {
                    ...
                    Message.sendImage(this._contactActive.chatId, this_user.email, file);
        ...
        this.el.inputDocument.on('change', e => {
            ...
            if (this.el.inputDocument.file.length) {
                ...
                .then(result => {
                    ...
                    this.filenamePanelDocumentPreview.innerHTML = file.name;
